            ...
            <Panel style={{ padding: "20px" }}>
              ...
              <div style={{ marginTop: "20px", border: "1px solid #e2e8f0", borderRadius: "16px", padding: "20px" }}>
                ...
                <ol style={{ margin: 0, paddingLeft: "20px", color: "#475569", fontSize: "14px" }}>
                  <li style={{ marginBottom: "8px" }}>Donate through <a href="https://lds.org/donations" target="_blank" rel="noopener noreferrer" style={{ color: "#2563eb", textDecoration: "underline" }}>LDS.ORG/Donations</a>. Be sure to use the <strong>"Local - Youth Camp Registration"</strong> line item on the donation slip.</li>
