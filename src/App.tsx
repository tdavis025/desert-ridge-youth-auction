                    ...
                    <Panel key={item.id} style={{ overflow: "hidden" }}>
                      ...
                      <div style={{ padding: "20px" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px" }}>
                          <div style={{ background: "#f1f5f9", borderRadius: "12px", padding: "12px" }}><div style={{ color: "#64748b", fontSize: "14px" }}>Retail value</div><div style={{ fontSize: "20px", fontWeight: 700 }}>{item.estimatedRetailValue ? formatCurrency(item.estimatedRetailValue) : "—"}</div></div>
